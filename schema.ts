...
/**
 * TODO: DEPLOYMENT
 * This file is being used only for development purposes,
 * so please don't use it in production and switch to npm
 * specifier while deploying.
 *
 * Instructions:
 * 1. Uncomment deps.ts (31:0 - 31:67)
 * 2. Comment deps.ts (33:1 - 33:22)
 */
...
export interface AlertInstance {
  ...
  analysis_key: string;
  /**
   * Identifies the variable values associated with the environment in which the analysis that generated this alert helper was performed, such as the language that was analyzed.
   */
  environment: string;
  /**
   * State of a code scanning alert.
